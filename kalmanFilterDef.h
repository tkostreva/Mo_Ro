...
#define NORTHSTAR_UNCERTAINTY_X  .15 // this is the uncertainty of the northstar readings, we are providing
#define NORTHSTAR_UNCERTAINTY_Y  .15 // you with the capability to independently set the x,y,and theta
#define NORTHSTAR_UNCERTAINTY_TH .05

#define WHEELENC_UNCERTAINTY_X  .03 // this is the uncertainty of the wheel encoder readings, 
#define WHEELENC_UNCERTAINTY_Y  .05 // 
#define WHEELENC_UNCERTAINTY_TH .05

#define PROCESS_UNCERTAINTY_X  .10 // this is the uncertainty about whether the robot will obey the model
#define PROCESS_UNCERTAINTY_Y  .10
#define PROCESS_UNCERTAINTY_TH .10
